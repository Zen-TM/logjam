...
const OZULTIMATE: OzEntry[] = [
  ...
  {
    name: "Breakfast Creek Canyon",
    altNames: [],
    url: BASE + "breakfast_creek.htm",
  },
  ...
  { name: "The River Caves", altNames: [], url: BASE + "river_caves.htm" },
  // Bungleboori
  {
    name: "Hole-in-the-Wall Canyon",
    altNames: ["Hole in the Wall"],
    url: BASE + "hole-in-the-wall.htm",
  },
  // Wollangambe
  {
    name: "Waterfall of Moss Canyon",
    altNames: [],
    url: BASE + "waterfall_of_moss.htm",
  },
  {
    name: "Whungee Wheengee Canyon",
    altNames: ["Wheengee Whungee"],
    url: BASE + "whungee_wheengee.htm",
  },
  { name: "Water Dragon Canyon", altNames: [], url: BASE + "water_dragon.htm" },
  { name: "Geronimo Canyon", altNames: [], url: BASE + "geronimo.htm" },
  {
    name: "Upper Wollangambe Canyon",
    altNames: ["Wollangambe Upper", "Upper Wollangambe"],
    url: BASE + "upper_wollangambe.htm",
  },
  {
    name: "Wollangambe Canyon - Upper Tourist Section (Wollangambe 1)",
    altNames: ["Wollangambe 1"],
    url: BASE + "wollangambe_1.htm",
  },
  {
    name: "Wollangambe Canyon - Lower Tourist Section (Wollangambe 2)",
    altNames: ["Wollangambe 2"],
    url: BASE + "wollangambe_2.htm",
  },
  { name: "Bell Creek Canyon", altNames: [], url: BASE + "bell_creek.htm" },
  {
    name: "Bell Creek Complete Canyon",
    altNames: [],
    url: BASE + "bell_creek_complete.htm",
  },
  {
    name: "Clatterteeth Canyon (Du Faur Creek)",
    altNames: ["Du Faur Creek"],
    url: BASE + "clatterteeth.htm",
  },
  {
    name: "Why Don't We Do It In The Road Canyon",
    altNames: [],
    url: BASE + "why_dont_we_do_it_in_the_road.htm",
  },
  {
    name: "Lower Bowens Creek North Canyon",
    altNames: ["Bowens Creek North Lower", "Lower Bowens Creek North"],
    url: BASE + "lower_bowens_creek_north.htm",
  },
  {
    name: "Bowens Creek North Canyon",
    altNames: [],
    url: BASE + "bowens_creek_north.htm",
  },
  {
    name: "Upper Bowens Creek South Canyon",
    altNames: ["Bowens Creek South Upper", "Upper Bowens Creek South"],
    url: BASE + "upper_bowens_creek_south.htm",
  },
  // North Grose
  ...
  {
    name: "Dargans Creek Canyon",
    altNames: [],
    url: BASE + "dargans_creek.htm",
  },
  ...
  {
    name: "Crayfish Creek Canyon",
    altNames: [],
    url: BASE + "crayfish_creek.htm",
  },
  // Jamison Valley
  ...
  {
    name: "Carrabeanga Falls",
    altNames: ["Carra Beanga", "Carrabeanga"],
    url: BASE + "carrabeanga_falls.htm",
  },
  { name: "Danae Brook Canyon", altNames: [], url: BASE + "danae_brook.htm" },
  {
    name: "Kanangra Main Canyon",
    altNames: ["Kanangra Main"],
    url: BASE + "kanangra_main.htm",
  },
  { name: "Kalang Falls", altNames: [], url: BASE + "kalang_falls.htm" },
  { name: "Dione Dell Canyon", altNames: [], url: BASE + "dione_dell.htm" },
  // South Coast
  {
    name: "Macquarie Pass Canyon",
    altNames: [],
    url: BASE + "macquarie_pass.htm",
  },
  // Bungonia
  {
    name: "Bungonia Creek Canyon",
    altNames: ["Bungonia Main", "Bungonia"],
    url: BASE + "bungonia_creek.htm",
  },
  {
    name: "Jerrara Creek Canyon",
    altNames: ["Jerrara"],
    url: BASE + "jerrara_creek.htm",
  },
