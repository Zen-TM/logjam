// Regenerates src/routeArrowSdf.ts — the direction arrowhead drawn along
...
const out = join(dirname(fileURLToPath(import.meta.url)), "../src/routeArrowSdf.ts");
writeFileSync(
  out,
  `// GENERATED by scripts/generate-route-arrow-sdf.mjs — do not edit by hand.
// Run that script to change the arrowhead's shape; \`routeArrow.ts\` scales
// it, so size is not a reason to regenerate. Guarded by routeArrow.test.ts.
//
