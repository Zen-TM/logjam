...
export const DEFAULT_PLACE_MERGE_POLICY: PlaceMergePolicy = {
  vGrade: "keepExisting",
  aGrade: "keepExisting",
...
export type PlaceMergeAttributes = {
...
export function mergePlace(
  ...
  const sources = mergeSources(
    (existingAttributes as PlaceMergeAttributes).sources,
    (incomingAttributes as PlaceMergeAttributes).sources,
  );
